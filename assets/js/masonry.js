...
document.addEventListener('DOMContentLoaded', function () {
    ...
    try {
        // First, check if there's an existing lightbox instance to destroy
        const existingLightboxes = document.querySelectorAll('.goverlay, .glightbox-container');
        existingLightboxes.forEach(function(element) {
            element.parentNode.removeChild(element);
        });
        
        // Initialize with complete options
        const lightbox = GLightbox({
            selector: '.pk-image-popup', // Use your PowerKit selector
